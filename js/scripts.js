...
function filterChange() {
  ...
  if (loadcountertotal >= 18) {
    filteredloadcounter = 18 - 1;
  } else {
    filteredloadcounter = loadcountertotal - 1;
  }
...
function loadStatData() {
  const api_url =
    "https://api.solradar.io/dd/latestPrices?collectionId=bored_ape_solana_club";
  ...
  async function getapi(url) {
    ...
    apistats[0].innerHTML =
      '\n                  <a href="https://magiceden.io/marketplace/bored_ape_solana_club"><span>' +
      data[0].listedCount +
      "</span>listed\n               ";
    ...
    apistats[2].innerHTML =
      '\n                  <a href="https://solradar.io/collection/bored_ape_solana_club/historical"><span>◎' +
      data[0].volume24hr.toFixed(2) +
      "</span>volume(24h)</a>\n               ";
  }
